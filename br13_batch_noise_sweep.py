...
parDict['sensor.sigma'] = 0.48   # 0.47, 0.48 give more non-accepted and 0.49 gives all..., too small range?
...
for j in range(nY):
    for k in range(nqSmax):
        ...
        plt.subplot(4,1,4)
        plt.step(Sn.t,Sn.x, where='post', color='b')
